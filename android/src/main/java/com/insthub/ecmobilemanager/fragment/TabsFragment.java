...
public class TabsFragment extends Fragment
{
    ...
    B0_StatisticsFragment homeFragment;
    D0_GoodsListFragment goodsListFragment;
	...
	void OnTabSelected(String tabName) {
        if (tabName == "tab_one")
        {
            ...
            {
                homeFragment = new B0_StatisticsFragment();
            }
...
//            this.tab_four.setImageResource(R.drawable.footer_user_icon);
        ...
        {
            goodsListFragment = new D0_GoodsListFragment();
            FragmentTransaction localFragmentTransaction = getFragmentManager().beginTransaction();
            localFragmentTransaction.replace(R.id.fragment_container, goodsListFragment, "tab_two");
            localFragmentTransaction.commit();
