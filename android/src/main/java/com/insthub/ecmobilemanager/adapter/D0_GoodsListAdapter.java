...
import com.insthub.ecmobilemanager.component.TwoGoodItemCell;
 ...
 *
 */
public class D0_GoodsListAdapter extends BeeBaseAdapter {


	public D0_GoodsListAdapter(Context c, ArrayList dataList) {
		super(c, dataList);		
	}
	...
	public View createCellView() {		
		return mInflater.inflate(R.layout.d0_goods_cell, null);
	}
