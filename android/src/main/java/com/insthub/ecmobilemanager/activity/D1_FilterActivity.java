...
import com.insthub.ecmobilemanager.component.AdvanceSearchValueCell;
import com.insthub.ecmobilemanager.model.AdvanceSearchModel;
...
public class D1_FilterActivity extends BaseActivity implements BusinessResponse {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.d1_filter);
        ...
        top_right_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try
                {
                    ...
                    D1_FilterActivity.this.setResult(RESULT_OK,it);
                    finish();
                }
                catch (JSONException e)
                {
