...
import com.insthub.ecmobilemanager.fragment.D0_GoodsListFragment;
 ...
 */
public class ECMobileManagerMainActivity extends FragmentActivity
{
            ...
            try
            {
                ...
                if (0 == actionString.compareTo("s")) {
                    ...
                    if (null != parameter && parameter.length() > 0) {
                        ...
                        Intent it = new Intent(this, D0_GoodsListFragment.class);
                        it.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        FILTER filter = new FILTER();
                        filter.keywords = parameter;
                        try {
                            it.putExtra(D0_GoodsListFragment.FILTER,filter.toJson().toString());
