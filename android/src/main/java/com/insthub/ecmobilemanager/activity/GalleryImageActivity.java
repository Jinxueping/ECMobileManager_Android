...
import com.insthub.ecmobilemanager.adapter.GalleryImageAdapter;
...
public class GalleryImageActivity extends BaseActivity implements OnGestureListener, OnTouchListener {
	...
	protected void onCreate(Bundle savedInstanceState) {		
        ...
        if(!isFirstRun) {
        	Intent it = new Intent(this, ECMobileManagerMainActivity.class);
            startActivity(it);
            finish();
        }
	...
	public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,
		...
		if (e1.getX() - e2.getX() > 120) {      
			if(pager_num == 5) {
				Intent intent = new Intent(GalleryImageActivity.this, ECMobileManagerMainActivity.class);
